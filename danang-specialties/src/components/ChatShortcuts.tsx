  ...
  if (icon === "zalo") {
    return (
      <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden fill="currentColor">
        <path d="M12.04 2C6.58 2 2.15 6.13 2.15 11.2c0 2.9 1.5 5.48 3.84 7.18v3.42l3.52-1.93c.8.22 1.65.34 2.53.34 5.46 0 9.89-4.13 9.89-9.2S17.5 2 12.04 2zm.9 12.4-2.52-2.69-4.92 2.69 5.4-5.74 2.58 2.69 4.86-2.69-5.4 5.74z" />
      </svg>
    );
  }
  if (icon === "messenger") {
    return (
      <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden fill="currentColor">
        <path d="M12 2C6.36 2 2 6.13 2 11.2c0 2.9 1.44 5.48 3.7 7.18V22l3.38-1.86c.95.26 1.96.4 3 .4 5.64 0 10.2-4.13 10.2-9.34C22.28 6.13 17.64 2 12 2zm1.04 12.55-2.66-2.83-5.2 2.83 5.72-6.07 2.72 2.83 5.14-2.83-5.72 6.07z" />
      </svg>
    );
  }
  return (
